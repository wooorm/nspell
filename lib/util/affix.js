 ...
 * @license MIT
 * @module nspell:util:affix
 * @fileoverview Parse an affix file.
 */
 ...
 *
 * @private
 * @param {Buffer} aff - Buffer of affix-file.
 */
function affix(aff) {
  var rules = {};
 ...
 *
 * @param {string} source - Expression-like source.
 * @return {RegExp} - Expression matching `source` at the
